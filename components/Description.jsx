    ...
    <div className="py-16 bg-black bg-opacity-20 rounded-lg">  
      <div className="container m-auto px-6 md:px-12 xl:px-6">
          <div className="space-y-6 md:space-y-0 md:flex md:gap-6 lg:items-center lg:gap-12">
            <div className="md:5/12 lg:w-5/12">
              <img src="http://techbytesinc.com/assets/img/about-us-vector.png" alt="image" loading="lazy" width="" height="" />
            </div>
      ...
      <div className="container m-auto px-6 md:px-12 xl:px-6 mt-10 mb-10">
          <div className="justify-end space-y-6 md:space-y-0 md:flex md:gap-6 lg:items-center lg:gap-12">
            ...
            <div className="md:5/12 lg:w-5/12">
              <img src="https://qq.co.id/wp-content/uploads/2019/04/kisspng-clip-art-recruitment-vector-graphics-illustration-philips-metal-industries-careers-5c648684496bc9.4283209715500919083007-982x780.png" alt="image" loading="lazy" width="" height="" />
            </div>
          </div>
      </div>
      <div className="container m-auto px-6 md:px-12 xl:px-6">
          <div className="space-y-6 md:space-y-0 md:flex md:gap-6 lg:items-center lg:gap-12">
            <div className="md:5/12 lg:w-5/12">
              <img src="https://user-images.githubusercontent.com/762297/59157609-ca692180-8ad7-11e9-88ab-552f8e88a202.png" alt="image" loading="lazy" width="" height="" />
            </div>
            <div className="md:7/12 lg:w-6/12">
