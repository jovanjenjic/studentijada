      ...
      <div className="container m-auto px-6 md:px-12 xl:px-6">
          <div className="space-y-6 md:space-y-0 md:flex md:gap-6 lg:items-center lg:gap-12">
            ...
            <div className="md:7/12 lg:w-6/12">
              ...
              <p className="mt-6 text-white">Codeference predstavlja ideju studenata, okupljenih sa jednim zadatkom da olakšaju tebi kao pojedincu i otkriju pravce i nova znanja koje možda ni ne poznaješ vezane za tvoju buduću karijeru.</p>
              <p className="mt-4 text-white">Codeference tim ima za zadatak da ti omogući kontakt sa ljudima koji će ti definitivno uticati na dalju budućnost!</p>
            </div>
          </div>
      </div>
      <div className="container m-auto px-6 md:px-12 xl:px-6 mt-10 mb-10">
          <div className="justify-end space-y-6 md:space-y-0 md:flex md:gap-6 lg:items-center lg:gap-12">
            <div className="md:7/12 lg:w-6/12">
              ...
              <p className="mt-6 text-white">Naš cilj je da okupimo što veći broj studenata iz oblasti elektrotehnike i računarstva i omogućimo komunikaciju između studenata i kompanija, da im se omogući neformalno obrazovanje i svi mogući izazovi prilikom prvog zaposlenja.</p>
      ...
      <div className="container m-auto px-6 md:px-12 xl:px-6">
          <div className="space-y-6 md:space-y-0 md:flex md:gap-6 lg:items-center lg:gap-12">
            ...
            <div className="md:7/12 lg:w-6/12">
              ...
              <p className="mt-6 text-white">Misija Codeference se ne ogleda samo u ova 3 dana, ona se bazira na stvaranju kulture razmene znanja između studenata i predavača, istim onim koji su bili kao i ti student.</p>
              <p className="mt-4 text-white">Znanje se možda ne može steći kroz 3 dana, ali težiće se ka tome da kroz stalne radionice i korisne informacije i predavanja u toku godine Codeference postane jedan od tvojih omiljenih izvora informacija.</p>
            </div>
          </div>
      </div>
