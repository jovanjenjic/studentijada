...
function WhatWeDo() {
  return (
    <div
      id="services"
      className="section relative pt-20 pb-8 md:pt-16 md:pb-0 bg-transparent"
    >
      <div className="container xl:max-w-6xl mx-auto px-4">
        <header className="text-center mx-auto mb-16 lg:px-20">
          ...
          <p className="text-light text-gray-200 text-xl">
            Ovo je ukratko o sadržaju, detaljnije o njemu ćeš saznati na
            konferenciji da ne kvarimo izenanđenje.
          </p>
        </header>
        <div className="flex flex-wrap flex-row -mx-4 text-center">
          <div
            className="flex-shrink lg:px-4 px-2 max-w-full w-full sm:w-1/2 lg:w-1/3 lg:px-6 wow fadeInUp"
