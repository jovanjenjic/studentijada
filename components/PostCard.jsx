    ...
    <div className="bg-white shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8">
      ...
      <div className="block lg:flex text-center items-center justify-center mb-8 w-full">
        ...
        <div className="font-medium text-gray-700">
          ...
          <span className="align-middle">{dayjs(post?.date || post?.createdAt).format('MMM DD, YYYY')}</span>
        </div>
      </div>
      ...
      <div className="text-center">
        <Link href={`/post/${post.slug}`}>
          <span className="transition duration-500 ease transform hover:-translate-y-1 inline-block bg-sky-500 text-lg font-medium rounded-full text-white px-8 py-3 cursor-pointer">Continue Reading</span>
        </Link>
      </div>
    </div>
  </motion.div>
