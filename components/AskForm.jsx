  ...
  return (
    <div className="bg-white shadow-lg rounded-lg p-8 pb-12 mb-8">
      ...
      <div className="grid grid-cols-1 gap-4 mb-4">
        <textarea value={formData.question || ''} onChange={onInputChange} className="p-4 outline-none w-full rounded-lg h-40 focus:ring-2 focus:ring-gray-200 bg-gray-100 text-gray-700" name="question" placeholder="Question" />
      </div>
